 ...
 */
export interface Executor<TMessage extends BaseMessage = BaseMessage> extends BaseExecutor {
  type: 'executor';
 ...
 */
export interface FunctionExecutor<TMessage extends BaseMessage = BaseMessage> extends BaseExecutor {
 ...
 * Type guard helpers
 */
export function isFunctionExecutor(executor: BaseExecutor): executor is FunctionExecutor {
  return executor.type === 'function-executor';
}

export function isWorkflowExecutor(executor: BaseExecutor): executor is WorkflowExecutor {
  return executor.type === 'workflow-executor';
}

export function isAgentExecutor(executor: BaseExecutor): executor is AgentExecutor {
  return executor.type === 'agent-executor';
}

export function isRequestInfoExecutor(executor: BaseExecutor): executor is RequestInfoExecutor {
  return executor.type === 'request-info-executor';
}

export function isMagenticAgentExecutor(executor: BaseExecutor): executor is MagenticAgentExecutor {

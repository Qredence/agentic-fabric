...
import { createWorkflowBuilder, validateWorkflow, workflowDefinitionToWorkflow } from '../workflow';
  ...
  describe('validateWorkflow', () => {
    ...
    it('should detect invalid edge sources', () => {
      const workflow = {
        ...
        edges: [{ id: 'edge-1', source: 'nonexistent', target: 'executor-1' }],
      };
    ...
    it('should detect invalid edge targets', () => {
      const workflow = {
        id: 'workflow-1',
        executors: [{ id: 'executor-1', type: 'executor' }],
        edges: [{ id: 'edge-1', source: 'executor-1', target: 'nonexistent' }],
      };
